...
class MnistData(data.Dataset):
    def __init__(self, data_dir=r'data/mnist',
                 class_num=9,
                 ds_type="train",
                 aug=False,
                 train_size=0.8,
    ...
    def check_files(self):
        ...
        if self.ds_type == "train":
            dataset = torchvision.datasets.MNIST(data_dir, train=True, download=False, transform=trans)
            ...
            dataset = torchvision.datasets.MNIST(data_dir, train=False, download=False, transform=trans)
